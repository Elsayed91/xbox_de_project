...
def test_get_sales_dataframe():
    ...
    dates = [pd.to_datetime(point['x'], unit='ms') for series in data['series'] for point in series['data']]
...
def test_calculate_other_sales():
    ...
    data = pd.DataFrame({
        ...
        'date': ['2005-11-26', '2005-11-26', '2005-11-26', '2005-11-26', '2005-12-24', 
                '2005-12-24', '2005-12-24', '2005-12-24'],
        'sales': [5, 5, 2, 16, 6, 4, 3, 15],
        'region': ['USA', 'Europe', 'Japan', 'Global', 'USA', 'Europe', 'Japan', 'Global']
    })
    ...
    expected_output = pd.DataFrame({
        'console': ['X360', 'X360', 'X360', 'X360', 'X360', 'X360', 'X360', 'X360',
                    'X360', 'X360'],
        'date': ['2005-11-26', '2005-12-24','2005-11-26', '2005-12-24','2005-11-26', 
                '2005-12-24', '2005-11-26','2005-12-24', '2005-11-26', '2005-12-24'],
        'region': ['Europe', 'Europe', 'Global', 'Global', 'Japan', 'Japan',
                'USA', 'USA', 'Others','Others'],
